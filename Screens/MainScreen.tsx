  ...
  return (
    <ScrollView className="bg-white bg-origin-border rounded-md border-darkGrey border-8">
      <TouchableOpacity onPress={() => navigation.navigate("Auth")}>
        {authCtx.isLogged ? (
          <Text className="text-center bg-red rounded-md self-end w-20 p-3 mt-3 mr-3 font-bold ">
            logout
          </Text>
        ) : (
          <Text className="text-center bg-red rounded-md self-end w-20 p-3 mt-3 mr-3 font-bold ">
      ...
      <Text className="text-darkGrey font-semibold text-3xl p-4 pl-6">
        Tarot Journal
      </Text>
      <TouchableOpacity onPress={() => navigation.navigate("OneCardReading")}>
        <View className="flex flex-wrap flex-row bg-blue w-screen pb-20 h-60 ">
          <Image
            className="scale-75 inline-flex p-0 m-0 -translate-y-3"
      ...
      >
        <Text className="text-center bg-red rounded-md w-80 self-center p-3 m-3 text-base font-bold">
          Three Card Reading
        </Text>
      </TouchableOpacity>
      <TouchableOpacity onPress={() => navigation.navigate("MyJournal")}>
        <Text className="text-center bg-red rounded-md w-80 self-center p-3 text-base font-bold">
          My Journal
        </Text>
      </TouchableOpacity>
