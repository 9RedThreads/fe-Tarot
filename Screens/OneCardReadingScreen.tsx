...
const OneCardReadingScreen = () => {
  ...
  const meaningsDark = selectedCard.meanings.shadow;
  ...
  return (
    <ScrollView className="bg-white">
      ...
      <Text className=" text-base text-center font-semibold p-3 pb-0 pt-5 rounded-md bg-white border-blue border-[12px] m-4">
        {questionToAsk}{" "}
      </Text>
        ...
        <ScrollView className="bg-red">
          ...
          <View className=" m-3 rounded-md bg-blue">
            <View className=" p-3 m-3 bg-white rounded-md w-11/12 self-center ">
              ...
              <View className=" inset-x-1">
                {isLightCardOne
                  ? meaningsLight.map((meaning) => {
                      return (
                  ...
                  : null}
                {!isLightCardOne ? meaningsDark.map((meaning) => {
                      return (
                        <Text key={meaning} className="">
                          {meaning}
                        </Text>
          ...
          <View>
            ...
            <ScrollView className=" m-3 rounded-md bg-blue">
            <Text className="text-xl self-center font-bold m-2 mt-3 ">Journal Entry</Text>
              <TextInput
                placeholder="Please type your diary entry here"
                onChangeText={setEntry}
                multiline={true}
